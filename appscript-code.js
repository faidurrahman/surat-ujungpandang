// SETUP FUNGSI UNTUK MEMBUAT HEADER TABEL OTOMATIS
function setupSheets() {
  const ss = SpreadsheetApp.openById('12YfPNcYea4gtWu8tO4WwNcdMXzENvwttygcZ57UG4KU');
...
function doPost(e) {
  try {
    // Karena menggunakan mode no-cors pada fetch di frontend, kita parse text plain
...
function addDisposisi(payload) {
  ...
  // Update status surat masuk (Disposisi aktif menjadi selesai jika role Selesai)
